...
const managersButtonEl = document.querySelector("#managers-button");
const managersModal = document.querySelector(".managers__modal");
// BODY
...
class building {
    ...
    render() {
        ...
        this.buildingBuyButtonEl.addEventListener("click", (e) => {
            e.preventDefault();
            this.buy(1);
        });
    }
